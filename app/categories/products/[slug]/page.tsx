...
const SingleProductPage = async ({ params }: { params: { slug: string } }) => {
    ...
    const {product, categoryName} = await getSingleProduct(params.slug)


  return (
		<section className="h-full w-full p-3 md:p-6">
			<div className="flex flex-col gap-3 justify-start items-start">
				<div className="flex flex-col md:flex-row p-2 gap-2 md:gap-4 justify-start items-start">
					<div className="p-0">
						<Image
					...
					<div className="flex flex-col gap-4 h-full justify-between mx-auto md:gap-8">
						<div className="flex flex-row justify-between gap-36 md:gap-80">
							<div className="">
								<h1 className="text-xl font-bold text-slate-900 text-nowrap">
									{product.name}
								</h1>
								<h3 className="text-sm font-light text-slate-900 pt-2 pb-1">
									{categoryName}
								</h3>
							</div>
							<div className="flex flex-row gap-3 items-start justify-center pt-2">
								<button
									type="button"
				...
				<div className="mt-8">
					...
					Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex obcaecati tempora, vitae quas quos nemo, fuga dolorem est quo sint modi! Obcaecati at nobis odio, error dolores animi facere ratione.
					</p>
				</div>

				<ul className="space-y-3 list-disc mt-6 pl-4 text-sm text-gray-500">
					<li>
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates magnam eius non dicta eligendi 
					</li>
					<li>
